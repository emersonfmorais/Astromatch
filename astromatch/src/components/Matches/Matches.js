...
const urlOne = 'https://us-central1-missao-newton.cloudfunctions.net/astroMatch/emersonfm/matches'
const urlTwo = 'https://us-central1-missao-newton.cloudfunctions.net/astroMatch/emersonfm/clear'
function Matches (){
